...
class SignUpViewModel : ViewModel() {
    ...
    fun signUp(fullName: String, email: String, phoneNumber:String, password: String, confirmPassword: String) {
        if (!validateInput(fullName, email, phoneNumber, password, confirmPassword)) return
            ...
            try {
                ...
                if (emailExists) {
                    ...
                    if (signUpResponse.isSuccess) {
                        ...
                        val saveResult = signupRepository.saveUserData(uid, fullName, email, phoneNumber)
